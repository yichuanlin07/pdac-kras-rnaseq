...
The [revised Week 2 report](reports/WK2YLINREP_2026-09-22_revised.pdf) adds workflow rationale, the Cutadapt decision and three-strand pilot comparisons while preserving all 17 full-run numerical results. It defers sample-specific troubleshooting discussion. The [full alignment review](reports/WK2YLINREP_2026-09-22_full_alignment.pdf) and analysis records retain the unresolved KRAS M1 finding; no result or QC status has changed. Earlier checked and interim PDFs remain historical snapshots. The [Chinese explanation](analysis/2026-09-22/interpretation_zh.md) covers earlier QC flags, file recovery and sample replication.
